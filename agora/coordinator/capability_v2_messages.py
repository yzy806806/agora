"""Protocol v2 message payload models.

Phase 14+.E.1: TaskResult, StructuredError, AgentMetadata,
ProtocolVersion.
"""
...
from .capability_v2_base import ErrorCategory, TaskResultStatus
...
class TaskResult(BaseModel):
    """v2 structured task result replacing flat success/error."""
